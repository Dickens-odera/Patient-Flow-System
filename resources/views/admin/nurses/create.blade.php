...
<div class="col-md-8">
    ...
    <div class="box">
        <div class="box-header bg-info text-uppercase text-white">{{ __('Add a new Nurse') }}</div>
        <div class="box-body">
                <form action="{{ route('admin.nurse.submit') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
